    ...
    if (buildingData) {
      ...
      if (buildingData.basements && buildingData.basements.length > 0) {
        ...
        const basementArray = buildingData.basements.map((b, index) => ({
          basementNumber:
            b.basement_number != null ? b.basement_number : index + 1,
    ...
    try {
      ...
      selectedFloors.forEach(floor => {
        ...
        if (floor.floorImage && floor.floorImage.uri) {
          ...
          typeof floor.floorImage === 'string' &&
      ...
      selectedBasements.forEach(basement => {
        ...
        if (basement.basementImage && basement.basementImage.uri) {
          formData.append('basement_image[]', {
            ...
            name:
              basement.basementImage.fileName ||
              `basement_${basement.basementNumber}.jpg`,
          });
        } else if (
          typeof basement.basementImage === 'string' &&
          basement.basementImage !== null
        ) {
          formData.append('basement_image[]', '');
        } else {
          formData.append('basement_image[]', '');
              ...
              <View
                ...
                {selectedFloors.map((floor, index) => (
                  <View
                    ...
                    <TextInput
                      ...
                      onChangeText={text =>
                        handleFloorNumberChange(text, index)
                      }
                    />
                    {/* <View style={styles.textfieldwrapper}>
                    ...
                    <TouchableOpacity
                      ...
                      onPress={() => selectImage('floor', index)}>
                ...
                {showBasementFields &&
                  selectedBasements.map((basement, index) => (
                    <View
                      key={basement.id || `basement-${index}`}
                      style={{marginTop: 20}}>
                      ...
                      <TextInput
                        ...
                        onChangeText={text =>
                          handleBasementNumberChange(text, index)
                        }
                      />
                      {/* <View style={styles.textfieldwrapper}>
                      ...
                      <TouchableOpacity
                        style={[styles.btn, {marginBottom: 20, marginTop: 20}]}
                        onPress={() => selectImage('basement', index)}>
